...
process.env.DB_PASSWORD = "230793@778Ab";
module.exports = {
 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "adhoc",
            password: "$2y$08$bEoCyQJQTjL6L.MDAkPOhOHsskbSSpVhDyuowgJk/PNaCwiXpvYba",
            permissions: "*"
        }]
    },
    ...
    https: {
      key: require("fs").readFileSync('/data/data/com.termux/files/home/.node-red/certs/server.key'),
      cert: require("fs").readFileSync('/data/data/com.termux/files/home/.node-red/certs/server.crt'),
      ca: require("fs").readFileSync('/data/data/com.termux/files/home/.node-red/certs/ca.crt')
    },
